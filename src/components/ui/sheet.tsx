...
const sheetVariants = cva(
  "bg-background fixed z-50 flex flex-col overflow-hidden shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        right:
...
function SheetBody({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex min-h-0 flex-1 flex-col gap-6 overflow-y-auto px-6 py-4", className)}
      {...props}
    />
  );
}
